...
Windows typically assigns the computer a long and complicated device name. This can be hard to remember when trying to find the server so it's best to create a new simpler name for the server.
